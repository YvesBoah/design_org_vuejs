  ...
  methods: {
      addTicket(e){
          if (1==0) {
              ...
              this.$http.post('http://7dd250b7.ngrok.io/ticket/create',newTicket)
      ...
      fetchEventLier() {
        this.$http.get('http://7dd250b7.ngrok.io/event/index')
            .then(function(response){
      ...
      fetchTypeLier() {
        this.$http.get('http://7dd250b7.ngrok.io/typeTicket/index')
            .then(function(response){
